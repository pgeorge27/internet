...
function getPropertyByName(node, nodeName) {
  ...
  for (var i=0; i<items.length; i++) {
    if (nodeName == items[i].firstChild.nodeValue) {
	  ...
	  if (items[i].parentNode.getElementsByTagName("value")[0]){
		if (items[i].parentNode.getElementsByTagName("value")){
			if (items[i].parentNode.getElementsByTagName("value")[0].firstChild){
