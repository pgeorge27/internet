	  ...
	  <tr> 
		<td height="40" colspan="2" valign="bottom"><div align="left"> 
            ...
            <td width="50px"><img src="<html:rewrite page='/images/gancho.gif' />"/></td>
				<td width="100%"><div align="left" class="login"><bean:message key="tit.title.consulta.estado.cuenta.cc"/></div></td>
				  </tr>
			</table></div></td>
	  </tr>
	  <tr> 
		...
		<%@ include file="../divHeader.jsp"%>
			<table width="100%" border="0" cellspacing="2" cellpadding="2">                   
				<tr> 
				  <td width="75%" height="20" class="catra-texto" align="center">
				  <table width="55%" border="0" cellpadding="0" cellspacing="2" align="center">
						<tr> 
						  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.desde"/></div></td>
						  <td height="15" class="bienvenida" align="right"><%=f.formatFecha((java.util.Date)ec.getFechaInicio(), locale)%></td>
						  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.hasta"/></div></td>
						  <td height="15" class="bienvenida" align="right"><%=f.formatFecha((java.util.Date)ec.getFechaFin(), locale)%></td></tr>
				 </table>
				 <table><tr><td >&nbsp;</td><td width="100%">
				 <table width="100%" border="0" cellpadding="2" cellspacing="2" align="center">
					<tr> 
					  <td height="15" width="45%" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.cuenta.corriente"/></div></td>
					  <td height="15" class="bienvenida" align="right" width="25%" ><%=f.formatCuenta(ec.getNumeroCuenta(), "C")%></TD>
					<td >&nbsp;</td></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.titular"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=((Titular)ec.Titulares.get(0)).getNombre()%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.moneda"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=ec.getMoneda()%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.saldo.inicio.mes"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=f.formatMonto(ec.getSaldoAnterior())%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.total.cheques.otros.debitos" arg0="<%=String.valueOf(ec.getCantidadDebitos())%>"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=f.formatMonto(ec.getTotalDebitos())%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.total.depositos.otros.creditos" arg0="<%=String.valueOf(ec.getCantidadDepositos())%>"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=f.formatMonto(ec.getTotalDepositos())%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.cc.saldo.fecha"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=f.formatMonto(ec.getSaldoTotal())%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.cc.saldo.reserva"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=f.formatMonto(ec.getSaldoTransito())%></TD></TR>
					<tr> 
					  <td height="15" class="celda-clave1">
								<div align="right" class="texto-acceso"><bean:message key="lbl.cc.saldo.disponible"/></div></td>
					  <td height="15" class="bienvenida" align="right"><%=f.formatMonto(ec.getSaldoDisponible())%></TD></TR>
				<tr> 
...
<tr class="tabla-acceso">
    ...
    <td class="texto-acceso" width="17%" align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="lbl.est.cta.detalle.saldo"/></TD></TR>
...
<TR valign="top" <%=styleClass%>>
    <td class="bienvenida" nowrap><%=f.formatFecha(m.getFechaValida(),locale)%></td>
    
    <td class="bienvenida" style="CURSOR: hand" 
        <%if ("D".equals(m.getTipoTransaccion())){%>
    ...
    <td class="bienvenida"><%=m.getNumeroDocumento()==null?"":m.getNumeroDocumento()%></td>
    <td class="bienvenida" align="right" nowrap><%=f.formatMonto(monto)%></td>
    <td class="bienvenida" align="right"><%=f.formatMonto(m.getSaldo())%></td>
</tr>
<%} /* End for - loop */ %>  
<%} /* End if  */ %>  
</table>
