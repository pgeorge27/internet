                              ...
                              <tr> 
                                <td width="46%" rowspan="2"><div align="center"> 
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                      <tr> 
                                        <td><div align="center">
                                        <img src="<html:rewrite page='/images/user_login.gif' />" border="0" title="Reingresar al sitio"/></div></td>
                                      </tr>
                                      <tr> 
                                        <td class="bienvenida"><p align="justify"><bean:message key="lbl.primer.cambio.clave"/></p>
										</td>
                                      </tr>
                                    </table>
                                  </div></td>                                
