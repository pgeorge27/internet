...
function printReciboXML(){
<%

TransferenciaInternacional IT = new TransferenciaInternacional();

IT.setMoneda(t.getMonedaAbanks());
IT.setMonto(t.getMonto());
IT.setNumeroDocumento(t.getNumeroDocumento());
IT.setFechaElaboracion(t.getFechaElaboracion());
IT.setEstado(t.getEstado());
IT.setBancoCorresponsal(t.getBancoCorresponsal());
IT.setReferenciaRecibida(t.getReferenciaRecibida());
IT.setCuentaBeneficiario(t.getCuentabancoBeneficiario());
IT.setNombreBeneficiario(t.getNombreBeneficiario());
IT.setDireccionBeneficiario(t.getDireccion());
IT.setCiudadBeneficiario(t.getCiudad());
IT.setPaisBeneficiario(t.getPais());
IT.setCuentaBancoIntermediario(t.getCuentaBancoIntermediario());
IT.setSwiftBancoIntermediario(t.getSwiftAbaInter());
IT.setNombreBancoIntermediario(t.getNombreBancoIntermediario());
IT.setDireccionBancoIntermediario(t.getDireccionBancoIntermediario());
IT.setCiudadBancoIntermediario(t.getCiudadBancoIntermediario());
IT.setPaisBancoIntermediario(t.getPaisBancoIntermediario());
IT.setSwiftBeneficiario(t.getCodigoSwiftABA());
IT.setBancoBeneficiario(t.getNonbrebancoBeneficiario());
IT.setDireccionBancoBeneficiario(t.getDireccionbancoBeneficiario());
IT.setCiudadBancoBeneficiario(t.getCiudadBancoBeneficiario());
IT.setPaisBancoBeneficiario(t.getPaisBancoBeneficiario());
IT.setNombreEmisor(t.getNombreEmisor());
IT.setInstrucciones(t.getInstrucciones());
IT.setUsuarioPrepara(t.getUsuarioPrepara());
IT.setDetalle(t.getDetalle());

session.setAttribute("detalle.transferencia.impresion", IT);
...
<table width="100%" cellpadding="5" cellspacing="5">
	<tr>
      <td align="center">
		...
		<div align="center">
			<a href="<html:rewrite page='/reciboxml/download'/>" onclick="printReciboXML();"  target="_new"><img src="<html:rewrite page='/images/icono_acrobat.gif'/>" border="0">&nbsp;Descargar Transferencia de Fondos en formato PDF</a></div>
	...
	<tr>
        ...
        if ("1".equals(target)){
        %>
	        <input type="button" class="botton" onclick="document.location='<html:rewrite page='/multipagos/aprobacion.jsp'/>'" value="<bean:message key="lbl.retroceder"/>" >
