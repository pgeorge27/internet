...
TranferenciaProcesada t = (TranferenciaProcesada)session.getAttribute("transfer");
			...
			<div class="panel panel-default" >
				...
				<div class="panel-body">
					...
					<html:form method="post" action="/multipago/autoriza" enctype="multipart/form-data"  >
						...
						<p class="bienvenida"><bean:message key="lbl.monto.transferencia.firma.transaccion.token" /></p>
						<p class="bienvenida"><input name="amount" id="amount_id2" readonly="readonly" type="text" value="<%=f.formatMonto(t.getMonto())%>"></p>
