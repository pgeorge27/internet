...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <tr> 
                                <td width="46%" rowspan="2"><div align="center"> 
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                      ...
                                      <tr> 
                                        <td class="bienvenida"><bean:message key="msg.service_does_not_respond_try_again"/></td>
                                      </tr>
									  <tr>
										<td class="bienvenida"><bean:message key="msg.document.could.not.be.generated"/></td>
									  </tr>
                                    </table>
                                  </div></td>                                
                              </tr>
  ...
  <tr>
    <td height="31" colspan="4" background="<html:rewrite page='/images/template_08.jpg'/>"><div align="center" class="derechos">&copy; 
        <bean:message key="msg.derechos.reservados"/></div></td>
  </tr>
</table>
</body>
