...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td><br>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr><td align="right"></td><img border="0" src="<html:rewrite page='/images/logo.jpg'/>"/></td></tr></table>
			<br></td>
    <td>&nbsp;</td>
          ...
          <td height="300" valign="middle"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr> 
                          <td height="0"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                              <tr> 
                                ...
                                <td width="54%" height="26" class="login">Login</td>
                              </tr>
                              <tr> 
                                    ...
                                    <tr> 
                                      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                                          ...
                                          <tr> 
											...
											<option value="es_CO" selected><bean:message key="lbl.espanol"/></option>
											<option value="en_UK"><bean:message key="lbl.ingles"/></option>
										   </select> </td>
              ...
              <tr> 
                <td><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="linea">
                    <tr> 
                      <td width="20%" class="tabla-acceso"><div align="center" class="bienvenida3">Noticia</div></td>
                      <td width="80%">&nbsp;</td>
                    </tr>
                    <tr> 
                      <td colspan="2"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                          <tr> 
                            <td class="bienvenida">
								<div align="justify"><common:mensaje-servicio servicio="5"  msgDefault="<%=message%>"/></div></td>
                          </tr>
                          <tr><td>&nbsp;</td></tr>
                          <tr><td>&nbsp;</td></tr>
                          <tr><td align="center">&nbsp;<script src=https://seal.verisign.com/getseal?host_name=www.helmcayman.com&size=M&use_flash=YES&use_transparent=YES></script></td></tr>                                             
                        </table></td>
                    </tr>
                  </table></td>
              </tr>
  ...
  <tr>
    <td height="31" colspan="4" style="width:100%;height:31;background-color:#4D4F53;"><div align="center" class="derechos">&copy; 
        <bean:message key="msg.derechos.reservados"  arg0="<%=String.valueOf(java.util.Calendar.getInstance().get(java.util.Calendar.YEAR))%>"/></div></td>
  </tr>
</table>
</body>
</html:html>