...
function send(){
	...
	if (!isDate(document.forms['vencimientoForm'].desde.value)){
		alert("<bean:message key="lbl.fecha.invalida"/>");
		document.forms['vencimientoForm'].desde.focus();
		return;
	}
	...
	if (!isDate(document.forms['vencimientoForm'].hasta.value)){
		alert("<bean:message key="lbl.fecha.invalida"/>");
		document.forms['vencimientoForm'].hasta.focus();
		return;
	}
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
                ...
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> <td width="50px"> <img src="<html:rewrite page='/images/gancho.gif'/>" border="0"></td>
                        <td><div align="left" class="login">Consulta Información de Importación y Exportación</div></td>
                                </tr>
                    </table>
                  </div></td>
              </tr>
              <tr> 
				...
				<html:form method="get" action="/vencimiento/seleccion/consulta"> 
