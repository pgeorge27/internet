...
<html:form method="post" action="/vencimiento/exportacion/ordinaria">
<input type="hidden" name="opcion" value="ordinaria"/>
<html:hidden property="indice"/>
<html:hidden property="secuenciaRegistro"/>
<html:hidden property="numeroDeclaracion"/>

<table width="100%" border="0" cellpadding="1" cellspacing="1" align="">
<tr>
	 <td><div align="left" class="login"><img src="<html:rewrite page='/images/gancho.gif'/>" border="0" style=" width : 24px;">Información de Exportación Ordinaria</div></td>
	 <td width="8%">
...
<tr class="bienvenida">
   <Td class="celda-clave1">Número Dex</Td>   
   <td>
   <html:text  styleClass="botton-acceso" property="dex" size="30%" maxlength="16" onkeypress="__digit(this);"/>
   </td>
</tr>
<tr class="bienvenida"> 
   <td class="celda-clave1">Fecha Dex</td>
   <td class="bienvenida">
...
<tr class="bienvenida">
   <td class="celda-clave1">Número Exportación</td>
   <td><html:text  styleClass="botton-acceso" property="numExportacion" size="30%" onblur="ValidarFecha();"  maxlength="16" onclick="ValidarFecha()"></html:text></td>   
</tr>
<tr class="bienvenida">
...
<tr class="bienvenida">
   ...
   <td><html:text  styleClass="botton-acceso" property="comprador" size="30%" maxlength="100"/></td>
</tr>
<tr class="bienvenida">
   <td class="celda-clave1">Vencimiento(<%= dias[1]%> días)</td>
   <td><html:text styleClass="botton-acceso"  property="vencimiento" size="30%" maxlength="20" readonly="true"/></td>
</tr>
<tr><td><h1></h1></td></tr>
<tr>
 <td colspan="2" align="center"> <input class="botton" type="button" value="Aceptar" onclick="submit()"/></td>
</tr>
</table>
