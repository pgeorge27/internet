...
<%
String tipoVencimiento = (String)session.getAttribute("tipo.vencimiento");
...
function __retornar(){
	document.location="<html:rewrite page='/vencimiento/modificacion/seleccion.do'/>";
}
function __edit(__index){
	document.forms["vencimientoForm"].indice.value = __index;
...
<html:form action="/vencimiento/modificacion/edicion" method="post">
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Modificar Información de Importación y Exportación</div></td>
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="2" align="center">
					<tr>
	                 ...
	                 <tr class="tabla-acceso">
                        <td class="texto-acceso" width="15%" align="center">Documento Transporte No.</td>
                        <td class="texto-acceso" width="10%" align="center">Fecha Transporte</td>
                        <td class="texto-acceso" width="15%" align="center">Importación No.</td>
                        <td class="texto-acceso" width="20%" align="center">Valor USD</td>
                        <td class="texto-acceso" width="20%" align="center">Proveedor</td>
                        <td class="texto-acceso" width="20%" colspan="2" align="center">Vencimiento (<%=dias[0] %> días)</td>
                     ...
                     <bean:define id="remainder0" value="<%=Integer.toString(resultNo.intValue() % 2) %>"/>			
					    ...
					    <logic:notEqual name="remainder0" value="0">
					       <tr class="celda-clave1">
	                        ...
	                        <td class="bienvenida"><input type="button" class="botton" name="btnedit" onclick="__edit(<%=resultNo.intValue()%>)" value="<bean:message key='lbl.compensacion.parametro.editar' />"/></td>
                    </tr>					    
                     </logic:iterate>
                     </logic:present>
				</table>
			...
			<tr> 
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="2" align="center">
					<tr>
	                 ...
	                 <tr class="tabla-acceso">
                        <td class="texto-acceso" width="15%" align="center">Número Dex Definitivo</td>
                        <td class="texto-acceso" width="10%" align="center">Fecha Dex Definitivo</td>
                        <td class="texto-acceso" width="20%" align="center">Exportación No.</td>                       
                        <td class="texto-acceso" width="15%" align="center">Valor USD</td>  
                        <td class="texto-acceso" width="20%" align="center">Comprador</td>
                        <td class="texto-acceso" width="20%" colspan="2"  align="center">Vencimiento (<%=dias[1] %> días)</td>                                                                      
                     </tr>
                     <logic:present name="vencimiento">
                     <logic:iterate name="vencimiento" id="row"
                     type="com.arango.internet.banking.Vencimiento" indexId="resultNo">
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="2" align="center">
					<tr>
	                 ...
	                 <tr class="tabla-acceso">
                        ...
                        <td class="texto-acceso" width="20%" align="center">Valor USD</td>
                        <td class="texto-acceso" width="20%" align="center">Comprador</td>
                        <td class="texto-acceso" width="20%" colspan="2" align="center">Vencimiento (<%=dias[2] %> días)</td>                                            
                     </tr>
                     <logic:present name="vencimiento">
                     <logic:iterate name="vencimiento" id="row"
                     type="com.arango.internet.banking.Vencimiento" indexId="resultNo">
