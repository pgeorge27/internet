...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">               
              <tr> 
                ...
                <tr><td><input type="button" class="botton" name="btncreate" onclick="__create()" value="Crear"/></td>
                    ...
                    <logic:iterate name="registro.dian" id="row"
					    ...
					    <logic:notEqual name="remainder" value="0">
					     ...
					     <logic:notEqual name="row" value="0" property="estado">
						   <input type="checkbox" name="indice" onclick="__set(<%=resultNo%>)" value="<%=resultNo%>"/><bean:write name="row" property="codigoConceptoOperacion"/>
						   <td class="bienvenida" align="center"><div>Pendiente x Elaborar</div>
						   </logic:notEqual>
						   <logic:equal name="row" value="0" property="estado">
						   <input type="checkbox" disabled="true" name="indice" onclick="__set(<%=resultNo%>)" value="<%=resultNo%>"/><bean:write name="row" property="codigoConceptoOperacion"/>
