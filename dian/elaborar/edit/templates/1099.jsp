...
function __retornar(){
	document.location="<html:rewrite page='/dian/elaborar/1099.jsp'/>";
}
</script>
      ...
      <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
              <td><input name="txtvalidar" type="hidden" styleId="txtvalidar" value="tipoNegociacion,codigoMoneda,tipoDocumentoVendedor,primerApellido,nombre,numeroIdentificacion,codigoMunicipioBeneficiario,telefonoVendedor,montoNegociado,tasaCompra,valorIVA,valorNeto,formaPago,numeroDeclaracionCambio,strFechaDeclaracionCambio,direccion"></td>
              <td><div align="right">
