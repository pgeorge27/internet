...
//******************************************************************************
    ...
    var scwDateDisplayFormat = 'yyyy/mmm/dd';     // e.g. 'MMM-DD-YYYY' for the US

    // Output date format

    //var scwDateOutputFormat  = 'DD MMM, YYYY'; // e.g. 'MMM-DD-YYYY' for the US
    var scwDateOutputFormat  = 'YYYY-MMM-DD'; // e.g. 'MMM-DD-YYYY' for the US
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #6B6B6B;}'  +
            '/* Drag Handle */'                                         +
            ...
            '/* Week day headings */'                                   +
            'td.scwWeek                 {color:             #F6F6F6;}'  +
            '/* Week numbers */'                                        +
            'td.scwWeekNo               {background-color:  #776677;'   +
                                        'color:             #F6F6F6;}'  +
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {background-color:  #F6F6F6;'   +
                                        'color:             #000000;}'  +
            ...
            'td.scwCellsExMonth         {background-color:  #F6F6F6;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
