		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td>
						<div align="center" class="txtTitulo">FORMULARIO 1066 Datos de la Importación - Declaración de cambio 1</div>
						</td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Número declaración cambio aclarada
						</div>
						</td>
						<td>
						<html:text property="numeroDeclaracionCambioAclarada" styleId="numeroDeclaracionCambioAclarada" 
					...
					<tr>
						...
						<td>
						<html:text property="valorUSDPagadoDeclaracion" styleId="valorUSDPagadoDeclaracion" maxlength="22" onkeypress="__digit(this);" /></td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Número documento de transporte </div>
						</td>
						<td>
