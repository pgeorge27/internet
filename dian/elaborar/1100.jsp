...
function __edit(formulario){
	...
	document.forms["formulario-dian"].action.value = "SAVE";
				...
				<html:form action="/dian/enviar/aprobar" method="post">
                    ...
                    <logic:iterate name="registro.dian" id="row"
					    ...
					    <logic:notEqual name="remainder" value="0">
						 ...
						 <td class="bienvenida"><input type="button" class="botton" name="btnedit" onclick="__edit(<%=resultNo.intValue()%>)" value="<bean:message key='lbl.compensacion.parametro.editar' />"/>                    </logic:iterate>
                    </table>
                    </html:form>
                    </div>
                    <script>
