...
if (cta == null){
    response.sendRedirect(request.getContextPath()+ "/dian/elaborar/seleccion.do");
}
              ...
              <tr> 
                ...
                <logic:present name="resumen.registro.dian">
                    ...
                    <logic:iterate name="resumen.registro.dian" id="row"
					    ...
					    <%
					     if ("1059".equals(row.getPropio()) || "1060".equals(row.getPropio()) || "1061".equals(row.getPropio())
                       ...
                       <td align="center" class="bienvenida"><a href="javascript:__detail(<bean:write name='row' property='propio'/>)"><bean:write name="row" property="descripcion"/></a></td>
                    ...
                    <table width="100%" align="center">
                         <tr class="tabla-acceso" width="80%"><td colspan="3" class="bienvenida"><div class="texto-acceso">&nbsp;&nbsp;Formularios Informativos</div></td></tr>
						 <tr class="tabla-acceso">
                       <td class="texto-acceso" align="center" width="60%"><div class="texto-acceso">Informe</div></td>
                       <td class="texto-acceso" align="center" width="2%"><div class="texto-acceso">Cantidad de Movimientos</div></td>
                       <td class="texto-acceso" align="center" width="20%"><div class="texto-acceso">Monto</div></td>
                 ...
                 totalCant = 0;%>
		                  ...
		                  <logic:iterate name="resumen.registro.dian" id="r"
								   type="com.arango.internet.banking.dian.Resumen" 
								   indexId="resulNo2" >
			     		<bean:define id="remainder1" value="<%=Integer.toString(resulNo2.intValue() % 2) %>"/>			
...
totalCant+=r.getCantidad(); 
                    ...
                    <html:form method="post" action="/dian/elaborar"> 
						<html:hidden property="estado" value="1"/>
						<html:hidden property="tipo" value="3"/>
						<% String doubleCuote = (String)session.getAttribute("cuenta.csic"); %>		
						<html:hidden property="cuenta" value="<%=doubleCuote%>"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="2">
	...
	<tr>
	<td></td> 
		<td valign="top" class="texto-acceso" width="100%" style=" width : 845px;"><div align="center"  ><br>
