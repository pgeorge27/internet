...
function send(){
	...
	if (document.forms['movimientoForm'].formulario.value == "0"){
		document.forms['movimientoForm'].estado.value= "0"
	}
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
		...
		<td height="40" valign="bottom"><div align="left"> 
	      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
	        <tr> <td width="50px"><img src="<html:rewrite page='/images/gancho.gif' />"/></td>
	          <td><div align="left" class="login"><bean:message key="lbl.compensacion.movimiento.titulo.elaborar"/></div></td>
	        </tr>
	      </table>
	    </div></td>
	</tr>
    <tr>
      <td valign="top" align="center">
		<html:form method="get" action="/dian/elaborar">
        ...
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
           ...
           -->
            ...
            <tr>
            <td  nowrap class="celda-clave1"><div align="right" class="texto-acceso">Tipo de Formato</div></td>
			<td>
			...
			<tr>
			    <td nowrap class="celda-clave1"><div align="right" class="texto-acceso">Estado</div></td>
			    <td>
			    	<html:select property="est" styleClass="lstbox">
			  	     <html:option value="">Todos</html:option>
			  	     <html:option value="1">Pendiente por Elaborar</html:option>
			  	     <html:option value="0">Ingresado</html:option>
			  		</html:select>
			   </td>
			</tr>
