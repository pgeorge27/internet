...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">                             
              <tr> 
                ...
                <tr><td>&nbsp;</td></tr>
                <tr>
                <td><input type="button" class="botton" name="btnedit" onclick="__submit()" value="Enviar a Generar XML"/></td></tr>
                  </table>
                  ...
                  <html:form action="/dian/enviar/aprobar" method="post"> 
                    ...
                    <logic:iterate name="registro.dian" id="row"
					    ...
					    <logic:notEqual name="remainder" value="0">
						 ...
						 <td class="bienvenida"><bean:write name="row" property="tipoCambioNegociacion" format="######0.00"/>
