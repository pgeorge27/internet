...
function __aprobar(){
	...
	if (count > 1){
		...
		alert("Debe seleccionar un registro para Enviar a Generar XML");
	}
}
function __editItem(){
	  var flag = false;
...
function __submit(){
	...
	if (count > 0){
		...
		alert("Debe seleccionar al menos un registro para enviar a generar XML");
	}
}
		...
		<td height="40" valign="bottom">
			<div align="left">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                <tr>
                  	<td><div align="left" class="login">Declaración De Cambio Por Importación De Bienes - Formulario NO 1 - 1059</div></td>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
	...
	<td valign="top">
		...
		<table cellpadding="1" width="30%" border="0">
            ...
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td align="left"><input type="button" class="botton" name="btnedit" onclick="__submit()" value="Enviar a Generar XML"/></td>
			</tr>
		</table>
        <table width="100%" border="0" cellpadding="1" cellspacing="2">
			<tr>
				<td><input type="checkbox" name="_all" onclick="__checkAll(this);">&nbsp;<bean:message key="lbl.compensacion.autorizar.seleccionar.todos"/></td>
			</tr>
		</table>
			...
			<html:form action="/dian/enviar/aprobar" method="post">
                    ...
                    <logic:iterate name="registro.dian" id="row"
					    ...
					    <td class="bienvenida">
						   ...
						   <input type="checkbox" name="indice" onclick="__set(<%=resultNo%>)" value="<%=resultNo%>"/><bean:write name="row" property="tipoInformante"/>						   
                           <td class="bienvenida" ><div>Pendiente x Elaborar</div>
						   </logic:notEqual>
						   
						   <logic:equal name="row" value="0" property="estado">
						   <input type="checkbox" disabled="true" name="indice" onclick="__set(<%=resultNo%>)" value="<%=resultNo%>"/><bean:write name="row" property="tipoInformante"/>
						   <td class="bienvenida" ><div>Ingresado</div>
						   </logic:equal>
		...
		<logic:notPresent name="registro.dian">
			<table width="80%" border="0" cellpadding="0" cellspacing="2">
				<tr class="tabla-acceso">
					<TD class="texto-acceso" width="15%"><bean:message key="msg.sin.movimentos"/></td>
				</tr>
			</table>
		</logic:notPresent>
	</td>
