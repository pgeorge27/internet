...
"<mas xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:noNamespaceSchemaLocation=\"1099.xsd\"> " +
"<Cab>"+
...
"telde=\"" +  StringUtilities.getValidXML(form1060.getTelefonoVendedor()) + "\" " + 
"actde=\"" +  StringUtilities.getValidXML(form1060.getOcupacionVendedor()) + "\" " + 
...
"tcom=\"" +  StringUtilities.getValidXML(String.valueOf(form1060.getTasaCompra())) + "\" " +
