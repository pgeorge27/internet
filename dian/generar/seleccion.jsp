...
function cambiaAction(_value){
	...
	if (text == 'TODAS LAS CUENTAS'){
		form.action='/internet/dian/generarCuentas.do';
		...
		form.action='/internet/dian/generar.do';
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
			...
			<div align="left"> 
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
					<tr> 
						...
						<td><div align="left" class="login"><bean:message key="lbl.compensacion.movimiento.titulo.generar"/></div></td>
					</tr>
				</table>
			</div>
		</td>
    ...
    <tr> 
        <td valign="top" align="center">
			<html:form method="get" action="/dian/generar"> 
				...
				<table width="90%" border="0" align="center" cellpadding="5" cellspacing="5">
					...
					<tr> 
						<td colspan="3">
							<table width="80%" border="0" align="center" cellpadding="5" cellspacing="5"></table>
						</td>
					</tr>
					<tr> 
						<td width="30%" class="celda-clave1">
							<div align="right" class="texto-acceso"><bean:message key="lbl.cuentas"/></div>
						</td>
						<td width="70%">
							<html:select property="cuenta" styleClass="lstbox" onchange="cambiaAction(this[selectedIndex].text);">
									<logic:notEmpty name="cuentasCompensacion">
										...
										<html:option value="0" >Todas las cuentas</html:option>
