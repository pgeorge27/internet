		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td>
						<div align="center" class="txtTitulo">FORMULARIO 1059 Información de los Documentos de Importación</div>
						</td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Año declaración importación</div>
						</td>
						<td>
						<html:text property="agnoDeclaracion" styleId="agnoDeclaracion" 
						size="20" maxlength="4" onkeypress="__digit(this)"/></td>
					</tr>
					<tr>
						<td>
						<div align="right" class="txtTexto">Número declaración importación
						</div>
						</td>
						<td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Valor USD declaración importación
						</div>
						</td>
						<td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Fecha documento de transporte
						</div>
						</td>
						<td nowrap>
					...
					<tr>
						...
						<td>
						<html:text property="numeroDocumentoTransporte" styleId="numeroDocumentoTransporte" maxlength="16" onkeypress="__alphabetic();"/></td>
					</tr>
