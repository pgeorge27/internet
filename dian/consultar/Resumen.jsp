...
if (cta == null){
    response.sendRedirect(request.getContextPath()+ "/dian/consultar/seleccion.do");
}
              ...
              <tr> 
                ...
                <logic:present name="resumen.registro.dian">
                 ...
                 totalCant = 0;%>
                    ...
                    <html:form method="post" action="/dian/consultar"> 
						<html:hidden property="estado" value="<%=estado%>"/>
						<html:hidden property="tipo" value="3"/>
<%
String cuentaCSIC = session.getAttribute("cuenta.csic").toString();
%>						
