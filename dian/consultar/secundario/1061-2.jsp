...
function __retornar(){
	document.location="<html:rewrite page='/dian/consultar/1061.jsp'/>";
}
</script>
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Declaración De Cambio Por Endeudamiento Externo - Formulario NO 3 - 1061 <br> Información de Numerales</div></td>
              ...
              <tr> 
				...
				<div id="record-view" >
                    ...
                    <tr class="tabla-acceso">
                       ...
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Valor moneda negociación">Valor moneda negociación</div></td>
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Valor moneda contratada">Valor moneda contratada</div></td>
                    ...
                    <logic:iterate name="registro.dian.secundario.2" id="row"
						...
						<td class="bienvenida"><bean:write name="row" property="valorMonedaNegociacion" format="######0.00"/></td>
