...
function __retornar(){
	document.location="<html:rewrite page='/dian/consultar/1060.jsp'/>";
}
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Declaración De Cambio Por Exportación De Bienes - Formulario NO 2 - 1060 <br> Información Declaraciones de exportación definitivas</div></td> 
