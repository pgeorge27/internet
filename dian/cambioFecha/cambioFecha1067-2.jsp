...
<%@ include file="/body.jsp"%>
				<html:form  action="/dian/cambiofecha/consultar"> 
					...
					<html:hidden property="formulariosSecundario" value="2" />
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Informe Datos Faltantes En Las Declaraciones De Cambio 2 - 1067 <br> Datos de la Exportación</div></td>
              ...
              <tr> 
				...
				<div id="record-view" style="overflow:auto;width:790;height:265">
                    ...
                    <tr class="tabla-acceso">
                       ...
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Fecha de presentación comunicacion u oficio">Fecha de presentación comunicación u oficio</div></td>
