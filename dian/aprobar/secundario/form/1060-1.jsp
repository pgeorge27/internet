...
function __retornar(){
	document.location="<html:rewrite page='/dian/elaborar/secundario/1060-1.jsp'/>";
}
</script>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td>
						<div align="center" class="txtTitulo">FORMULARIO 1060 Información Declaraciones de exportación definitivas</div>
						</td>
					...
					<tr>
						...
						<html:text property="numeroDEXDefinitivo" styleId="numeroDEXDefinitivo" 
							 size="20" maxlength="16" onkeypress="__alphabetic();"/></td>
					</tr>
					<tr>
						<td>
						<div align="right" class="txtTexto">Fecha DEX definitivo
						</div>
						</td>
						<td>
						...
						alt="Calendario" width="16" height="16">[<b>yyyy-mm-dd</b>]</td></td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Valor reintegrado USD
						</div>
						</td>
						<td>
						<html:text property="valorMonedaReintegro" styleId="valorMonedaReintegro" maxlength="22" onkeypress="__digit(this);" /></td>
					</tr>
