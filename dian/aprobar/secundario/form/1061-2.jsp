...
function __retornar(){
	document.location="<html:rewrite page='/dian/elaborar/secundario/1061-2.jsp'/>";
}
</script>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td>
						<div align="center" class="txtTitulo">FORMULARIO 1061 Información de Numerales</div>
						</td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Valor moneda negociación
						</div>
						</td>
						<td>
						<html:text property="valorMonedaNegociacion" styleId="valorMonedaNegociacion" maxlength="22" onkeypress="__digit(this);" /></td>
					</tr>
					<tr>
						<td>
