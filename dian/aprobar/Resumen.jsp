...
if (cta == null){
    response.sendRedirect(request.getContextPath()+ "/dian/aprobar/seleccion.do");
}
              ...
              <tr> 
                ...
                <logic:present name="resumen.registro.dian">
                    ...
                    <form name="consulta" method="post" action="<html:rewrite page='/do.consulta'/>">
	                    ...
	                    <input type="hidden" name="cuentas" value="<%=session.getAttribute("cuenta.csic")%>"/>
                    </form>
                    <html:form method="post" action="/dian/aprobar"> 
						<html:hidden property="estado" value="2"/>
