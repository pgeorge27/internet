		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td>
						<div align="center" class="txtTitulo">FORMULARIO 1064 Plan de amortización</div>
						</td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Fecha
						</div>
						</td>
						<td>
						<html:text property="fecha" styleId="fecha" 
					...
					<tr>
						...
						<td nowrap>
						<html:text property="strFechaCuota" styleId="fechaCuota" 
						size="20" maxlength="10"/><img src="<html:rewrite page='/dian/elaborar/edit/images/cal.gif'/>" 
						onclick="return showCalendar('fechaCuota', 'y-mm-dd');" 
