		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td>
						<div align="center" class="txtTitulo">FORMULARIO 1059 Información de la Descripción de la Operación</div>
						</td>
					...
					<tr>
						<td>
						<div align="right" class="txtTexto">Código moneda de giro
						</div>
						</td>
						<td>
