	...
	<tr><td><input type="checkbox" name="_all" onclick="__checkAll(this);">&nbsp;<bean:message key="lbl.compensacion.autorizar.seleccionar.todos"/></td></tr>
				...
				<html:form action="/dian/modificar/aprobar" method="post">
                    ...
                    <tr class="tabla-acceso">
                        <td class="texto-acceso" align="center"><div class="texto-acceso">Tipo negociación</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Número factura o doc. Equivalente</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Tipo documento declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Número documento identificación declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Dígito Verificación</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso">Dirección Declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Código Departamento/Municipio Declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Teléfono Declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Ocupación o actividad económica declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Tipo documento Beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Número documento identificación  Beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Dígito Verificación</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso">Razón social beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Dirección Beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Código Departamento/Municipio Beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Teléfono Beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Ocupación o actividad económica  Beneficiario.</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Código Moneda</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso">Código Banco</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Número cheque</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Número Declaración Cambio</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Fecha declaración cambio</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso">Identificación única registro</div></td>
