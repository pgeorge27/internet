...
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="5">
              <tr> 
                <td height="40" valign="bottom"><div align="center"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login"><bean:message key="lbl.compensacion.movimiento.titulo.modificar"/></div></td>
              ...
              <tr> 
				...
				<html:form method="get" action="/dian/modificar"> 
                      ...
                      <tr> 
                       ...
                       <tr> 
						...
						<td nowrap><html:select property="estado" styleClass="lstbox">
													<html:option value="6">Todos</html:option>																									
						  ...
						  <span class="texto-acceso">(<font color="#FF0000">*</font>)</span>
                            ...
                            <tr>
                                   <td  nowrap class="celda-clave1"><div align="right" class="texto-acceso">Tipo de Formularios</div></td>
							       <td>
									<html:select property="formulario" styleClass="lstbox">
										...
										<html:option value="1063">1063 - Informe de datos de endeudamiento externo otorgando a  residentes - formulario 6	</html:option>
										<html:option value="1064">1064 - Informe de datos de endeudamiento externo otorgando a  no residentes - formulario 7	</html:option>
										...
										<html:option value="1070">1070 - Informe de datos cuenta corriente de compensación	</html:option
										<html:option value="1099">1099- Informe de datos de la compra de divisas en efectivo  y cheques de viajero</html:option>
										<html:option value="1100">1100- Informe de datos de la venta de divisas en efectivo y cheques de viajero	</html:option>
										<html:option value="1121">1121- Informe datos compra y venta de divisas en efectivo y cheques de viajero zona de frontera  - montos inferiores a usd 500.00</html:option>			 >-->
									</html:select>
								</td> 
							  </tr>
