...
function __retornar(){
	document.location="<html:rewrite page='/dian/modificar/1066.jsp'/>";
}
</script>
<%
...
<input type="hidden" name="formulario" value="1066">
	<html:hidden property="indice"/>
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="cuadro">
    <tr>
      <td><input type="hidden" name="formulario" value="1066">
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td><div align="center" class="txtTitulo">FORMULARIO 1066</div></td>
            ...
            <tr>
              ...
              <td><input name="strFecha" type="text" class="txtTexto" id="strFecha"  maxlength="10" size="20" value="<bean:write name="formulario-dian" property="strFecha"/>">
                <img src="<html:rewrite page='/dian/elaborar/edit/images/cal.gif'/>" onclick="return showCalendar('strFecha', 'y-mm-dd');" alt="Calendario" width="16" height="16">[<b>yyyy-mm-dd</b>]</td>
            </tr>
            <tr>
              <td><div align="right" class="txtTexto">Procesamiento de la declaraci&oacute;n de cambio: </div></td>
            ...
            <tr>
              <td><div align="right" class="txtTexto">Fecha declaraci&oacute;n cambio aclarada: </div></td>
              <td><html:text property="strFechaDeclaracionAclarada" styleClass="txtTexto"  maxlength="10" styleId="strFechaDeclaracionAclarada" size="20" />
                  <img src="<html:rewrite page='/dian/elaborar/edit/images/cal.gif'/>" onclick="return showCalendar('strFechaDeclaracionAclarada', 'y-mm-dd');" alt="Calendario" width="16" height="16">[<b>yyyy-mm-dd</b>]</td>
            </tr>
            <tr>
              <td><div align="right" class="txtTexto">N&uacute;mero declaraci&oacute;n cambio aclarada: </div></td>
              <td><input name="numeroDeclaracionCambioAclarada" type="text" class="txtTexto"  maxlength="5" id="numeroDeclaracionCambioAclarada" size="40" value="<bean:write name="formulario-dian" property="numeroDeclaracionCambioAclarada"/>"></td>
            </tr>
            <tr>
              <td><div align="right" class="txtTexto">Tipo de identificaci&oacute;n del importador o exportador, o del deudor o acreedor, o de quien compra o vende divisas: </div></td>
            ...
            <tr>
              <td><div align="right" class="txtTexto">N&uacute;mero de identificaci&oacute;n del importador o exportador, o del deudor o acreedor, o de quien compra o vende divisas.: </div></td>
            ...
            <tr>
              <td><div align="right" class="txtTexto">DV  del importador o exportador, o del deudor o acreedor, o de quien compra y vende divisas.: </div></td>
              <td><input name="digitoVerificador" type="text" class="txtTexto"  maxlength="1" id="digitoVerificador" size="40" value="<bean:write name="formulario-dian" property="digitoVerificador"/>"></td>
            </tr>
            <tr>
              <td><div align="right" class="txtTexto">Primer apellido del importador o exportador, o del deudor o acreedor, o de quien compra y vende divisas: </div></td>
            ...
            <tr>
              <td><div align="right" class="txtTexto">Segundo apellido del importador o exportador, o del deudor o acreedor, o de quien compra y vende divisas.: </div></td>
            ...
            <tr>
              <td><div align="right" class="txtTexto">Primer nombre del importador o exportador, o del deudor o acreedor, o de quien compra y vende divisas: </div></td>
              <td><input name="nombre" type="text" class="txtTexto" id="nombre" maxlength="60" onkeypress="alphabetic();" value="<bean:write name="formulario-dian" property="nombre"/>" size="40" value="<bean:write name="formulario-dian" property="nombre"/>"></td>
            </tr>
            <tr>
              <td><div align="right" class="txtTexto">Otro nombres del importador o exportador, o del deudor o acreedor, o de quien compra y vende divisas: </div></td>
            ...
            <tr>
              <td><div align="right" class="txtTexto">Raz&oacute;n social del importador o exportador, o del deudor o acreedor, o de quien compra y vende divisas: </div></td>
            ...
            <tr>
              <td><input name="txtvalidar" type="hidden" id="txtvalidar" value="tipoInformante,procesamientoDeclaracion,strFechaDeclaracionAclarada"></td>
              <td><div align="right">
