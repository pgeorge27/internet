...
<html:form method="post" action="/dian/elaborar"> 
	<html:hidden property="estado" value="6"/>
	<html:hidden property="tipo" value="3"/>
	<html:hidden property="cuenta" value="<%=session.getAttribute("cuenta.csic").toString()%>"/>
	<html:hidden property="formulario" value="<%=session.getAttribute("formulario").toString()%>"/>
                       ...
                       <tr> 
                         <td width="46%" rowspan="2"><div align="center"> 
                             <table width="100%" border="0" cellspacing="2" cellpadding="2">
							   ...
							   <tr>
								 <td class="bienvenida">Formulario(s) enviado(s) a autorización exitósamente.</td>
							   </tr>
