               ...
               <html:form method="post" action="/dian/reproceso"> 
                    ...
                    <table cellpadding="1" style="overflow:scroll;width:50%">
                     ...
                     <tr>
	                      ...
	                      <td class="bienvenida"><b><html:text property="version" size="20" value="6" disabled="true"/></b></td>                      
                     </tr>
                       <tr>
	                      <td class="celda-clave1">Versión del Formato</td>
	                      ...
	                      <input type="text" name="version" size="20" value="<%=version %>" disabled/>
						  <html:hidden property="versionFormato" value="<%=version %>"/></b></td>                      
                     </tr>
                     <tr>
	                      <td class="celda-clave1">Número de Envío</td>
	                      <td class="bienvenida"><html:text property="numeroEnvio" size="20" maxlength="2"/></td>                      
                     </tr>
                     <tr>
