              ...
              <tr> 
				...
				<html:form action="/dian/exportar/excel" method="post">
                    ...
                    <tr class="tabla-acceso">
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso"title="Número de la cuenta corriente de compensación"># cuenta corriente de compensación</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso"title="Nombre del banco">Nombre banco</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso"title="Código país">Código país</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso"title="Fecha de cancelación de la cuenta en la entidad bancaria del exterior">F. cancelación de Cta. entidad bancaria del exterior</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso"title="Fecha del reporte de cancelación de la cuenta ante el Banco de la República">F. reporte cancelación Cta. ante Banco de la República</div></td>
