...
if (cta == null){
    response.sendRedirect(request.getContextPath()+ "/dian/exportar/seleccion.do");
}
                 ...
                 totalCant = 0;%>
                    ...
                    <script>
                    	function __detail(formulario){
	                    	document.forms["movimientoFormXML"].formulario.value = formulario;
                    ...
                    <form name="consulta" method="post" action="<html:rewrite page='/do.consulta'/>">
	                    ...
	                    <input type="hidden" name="backPage" value="<html:rewrite page='/dian/exportar/Resumen.jsp'/>" >
                    ...
                    <html:form method="post" action="/dian/exportar"> 
						...
						<html:hidden property="trimestre" value='<%=session.getAttribute("trimestre")%>'/>
						<html:hidden property="anio" value="<%=session.getAttribute("anio")%>"/>
					</html:form>
                    </logic:present>
