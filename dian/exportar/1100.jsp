				...
				<html:form action="/dian/exportar/excel" method="post">
                    ...
                    <logic:iterate name="registro.dian" id="row"
					    ...
					    <logic:notEqual name="remainder" value="0">
						 ...
						 <td class="bienvenida"><bean:write name="row" property="promedioCompra"/>
						 <td class="bienvenida"><bean:write name="row" property="diferenciaTasa"/>
						 <td class="bienvenida"><bean:write name="row" property="baseLiquidacion"/>
