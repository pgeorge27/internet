              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Endeudamiento Externo Otorgados a Residentes -  FORMULARIO NO 6   - 1063 <br> Información declaraciones de importación</div></td>
              ...
              <tr> 
				...
				<div id="record-view" style="overflow:auto;width:790;height:265">
                    ...
                    <tr class="tabla-acceso">
                       ...
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Numero declaración importación">Numero declaración importación</div></td>
                    ...
                    <logic:iterate name="registro.dian.secundario.2" id="row"
	                    ...
	                    <td class="bienvenida"><bean:write name="row" property="agnoDeclaracion"/>
