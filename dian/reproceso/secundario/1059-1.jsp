...
function __retornar(){
	document.location="<html:rewrite page='/dian/reproceso/1059.jsp'/>";
}
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Declaración De Cambio Por Importación De Bienes - Formulario NO 1 - 1059 <br> Información de la Descripción de la Operación</div></td>
              ...
              <tr> 
				...
				<div id="record-view" style="overflow:auto;width:790;height:265">
                    ...
                    <tr class="tabla-acceso">
                       ...
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Código moneda de giro">Código moneda de giro</div></td>                       
                    ...
                    <logic:iterate name="registro.dian.secundario.1" id="row"
						...
						<td class="bienvenida"><bean:write name="row" property="tipoCambioUSD"/></td>
						<td class="bienvenida"><bean:write name="row" property="numeral"/></td>
						<td class="bienvenida"><bean:write name="row" property="valorMonedaGiro"/></td>
