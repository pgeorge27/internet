...
function __retornar(){
	document.location="<html:rewrite page='/dian/reproceso/1067.jsp'/>";
}
</script>
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Informe Datos Faltantes En Las Declaraciones De Cambio 1 Y  2 - 1067 <br> Datos de la Importación</div></td>
              ...
              <tr> 
				...
				<div id="record-view" style="overflow:auto;width:790;height:265">
                    ...
                    <logic:iterate name="registro.dian.secundario.1" id="row"
	                    ...
	                    <logic:notEqual name="row" property="agnoDeclaracion" value="0">
						      <td class="bienvenida"><bean:write name="row" property="agnoDeclaracion"/></td>	
					     </logic:notEqual>
						 <logic:equal name="row" property="agnoDeclaracion" value="0">
	                    ...
	                    <td class="bienvenida"><bean:write name="row" property="fechaDocumentoTransporte" formatKey="formato-fecha"/>	
	                    <td class="bienvenida"><bean:write name="row" property="numeroDocumentoTransporte"/>
