...
function __retornar(){
	document.location="<html:rewrite page='/dian/reproceso/1064.jsp'/>";
}
</script>
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Informe de Endeudamiento Externo  Otorgado a No Residentes - FORMULARIO NO 7 - 1064 <br> Plan de Amortización</div></td>
                    ...
                    <logic:iterate name="registro.dian.secundario.1" id="row"
	                    ...
	                    <td class="bienvenida"><bean:write name="row" property="fecha" formatKey="formato-fecha"/>
  	                    <td class="bienvenida"><bean:write name="row" property="numeroPrestamo"/>	
  	                     <td class="bienvenida"><bean:write name="row" property="fechaCuota" formatKey="formato-fecha"/>			
