...
function __retornar(){
	document.location="<html:rewrite page='/dian/reproceso/1066.jsp'/>";
}
</script>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">     
              <tr> 
                ...
                <tr><td><input type="button" class="botton" name="btnedit" onclick="__editItem()" value="<bean:message key='lbl.compensacion.parametro.editar' />"/></td>                
                </tr></table>
