...
function __retornar(){
	document.location="<html:rewrite page='/dian/reproceso/1063.jsp'/>";
}
</script>
              ...
              <tr> 
                <td height="40" valign="bottom"><div align="left"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td><div align="left" class="login">Endeudamiento Externo Otorgados a Residentes -  FORMULARIO NO 6   - 1063 <br> Plan de amortización</div></td>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">     
              <tr> 
                <td valign="top">
                <logic:present name="registro.dian.secundario.3">
				...
				<div id="record-view" style="overflow:auto;width:790;height:265">
                    ...
                    <tr class="tabla-acceso">
                       ...
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Fecha - Cuota Plan de Amortización">Fecha - Cuota Plan de Amortización</div></td>
                       <td class="texto-acceso" align="center"><div class="texto-acceso" title="Valor moneda contratada - Cuota Plan de Amortización">Valor moneda contratada - Cuota Plan de Amortización</div></td>
                    ...
                    <logic:iterate name="registro.dian.secundario.3" id="row"
			...
			<logic:notPresent name="registro.dian.secundario.3">
