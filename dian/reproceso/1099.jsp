              ...
              <tr> 
				...
				<html:form action="/dian/reproceso/xml" method="post">
                    ...
                    <tr class="tabla-acceso">
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Número factura o doc. Equivalente"># factura Equivalente</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Número documento de identificación del declarante vendedor"># Doc. identificación declarante vendedor</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Dirección del Declarante vendedor">Dirección Declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Código Departamento/Municipio del Declarante vendedor">Código Departamento/Municipio Declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Teléfono del Declarante vendedor">Teléfono Declarante vendedor</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Ocupación o actividad económica del declarante vendedor">Ocupación o actividad económica declarante vendedor</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Número documento de identificación del Beneficiario"># Doc. identificación  Beneficiario</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Dígito de Verificación">Dígito Verificación</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Ocupación o actividad económica del Beneficiario">Ocupación o actividad económica  Beneficiario</div></td>
						...
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Número Declaración de Cambio"># Declaración Cambio</div></td>
						<td class="texto-acceso" align="center"><div class="texto-acceso" title="Fecha declaración de cambio">F. declaración cambio</div></td>
                    ...
                    <logic:iterate name="registro.dian" id="row"
					    ...
					    <logic:notEqual name="remainder" value="0">
					     ...
					     <td class="bienvenida"><bean:write name="row" property="tipoNegociacion"/>
							 ...
							 <td class="bienvenida"><bean:write name="row" property="tasaCompra"/>
							 ...
							 <td class="bienvenida"><bean:write name="row" property="valorNeto"/>
