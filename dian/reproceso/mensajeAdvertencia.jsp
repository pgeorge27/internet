...
<br><br>
	...
	<table>
	   <tr>
	         <td align="center"><INPUT class="botton" onclick="document.location='<html:rewrite page='/dian/generar/seleccion.jsp'/>'" type="button" value="<bean:message key="lbl.retroceder"/>"></div></td>
      </tr>
	</table>
