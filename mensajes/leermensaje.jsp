...
<%
	...
	MensajeBanco msb = mb.devolverRespuesta(Integer.parseInt(empresa), Long.parseLong(respuesta));
%>
...
<table width="750" border="0" cellpadding="0" cellspacing="0" align="left">
 <tr> 
  ...
  <tr>
  	<td align="right">
  	   <a href="do.mensajesbanco?tipo=L&id=<%=respuesta %>&empresa=<%=empresa%>">
  	   <img src="<html:rewrite page='/images/mensajes/mailopen.png' />" border="0" title="Marcar como Leído"/></a>
  	   &nbsp;&nbsp;
  	  <a href="do.mensajesbanco?tipo=B&id=<%=respuesta%>&empresa=<%=empresa%>">
