...
<table cellpadding="1" cellspacing="1" width="750" align="center" class="tabla-acceso">
  <tr><td>
	...
	<div align="center"> 
	    <html:form action="/save/persona/juridica">
	    	 ...
	    	 <table class="marco" border="0" cellspacing="1" cellpadding="1">
				...
				<tr valign="top">
					...
					<div id="__direccionFisica" style="display:<bean:write name='frmPersona' property='tipoDireccionFisica'/>">
						<table width="100%" border="0" cellspacing="1" cellpadding="1">	
							<tr valign="top">
				    	 		<td class="celdas" width="5%"><font color="#FF0000">*</font></td>
								<td class="celdas-border" width="30%"><bean:message key="lbl.actualiza.juridico.direccion.envio.correspondencia"/></td>
								...
								<td class="celdas" width="60%"><html:textarea property="direccionCorrespondencia" cols="45" rows="3" styleClass="textfield2" onkeypress="return imposeMaxLength(event, this, 200);" /></td>
							<td width="5%">
								<logic:messagesPresent name="msg_direccionCorrespondencia">
									<img src="<html:rewrite page='/images/warning_sml.gif'/>"/>
									<script type="text/javascript">
										__setChangeColor("direccionCorrespondencia");
									</script>
								</logic:messagesPresent>
							</td></tr>
						</table>
	    	 ...
	    	 <table class="marco" border="0" cellspacing="1" cellpadding="1">
			  ...
			  <%@ include file="/WEB-INF/marco/fin.jsp"%>
				...
				<tr>
				   ...
				   <input type="button" class="botton" onclick="__submit();" value="<bean:message key='lbl.actualiza.boton.actualizar'/>"/>
	    	 	</table>
	    </html:form> 
   </div></td></tr></table>
			    <ajax:select
