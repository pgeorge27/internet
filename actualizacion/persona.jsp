...
<table cellpadding="1" cellspacing="1" width="750" align="center" class="tabla-acceso">
  <tr><td>
	...
	<div align="center">
	    <html:form action="/save/persona/natural">
				...
				<tr valign="top">
					...
					<div id="__direccionFisica" style="display:<bean:write name='frmPersona' property='tipoDireccionFisica'/>">
						<table width="100%" border="0" cellspacing="1" cellpadding="1">	
							<tr valign="top">
				    	 		<td class="celdas" width="5%"><font color="#FF0000">*</font></td>
								<td class="celdas-border" width="30%"><bean:message key="lbl.actualiza.natural.direccion.fisica"/></td>
								<td class="celdas" width="60%"><html:textarea property="direccionFisica" cols="45" rows="3" styleClass="textfield2" onkeypress="return imposeMaxLength(event, this, 200);"/></td>
							<td width="5%">
								<logic:messagesPresent name="msg_direccionFisica">
									<img src="<html:rewrite page='/images/warning_sml.gif'/>"/>
									<script type="text/javascript">
										__setChangeColor("direccionFisica");
									</script>
								</logic:messagesPresent>
							</td></tr>
						</table>
