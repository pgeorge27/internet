	...
	<html:form method="post" action="/cambioImagenToken.do">	
	 <table cellspacing="3" cellpading="3" align="center" width="90%">
       <tr valign="top">
	      ...
	      <td align="left" class="fuente-titulo"><bean:message key="lbl.token.cambio.imagen.titulo"/></td>
	      </tr></table>
	      </td>
	    </tr>
      <tr>
	    <td class="fuente-principal">
		   	<bean:message key="lbl.token.cambio.imagen.mensaje"/><br/>
		   	<b><bean:message key="lbl.cambio.imagen.skip.warning"/><br/></b>
		   	<br>
			<bean:message key="lbl.token.cambio.imagen.pregunta"/><br/>
  	        <input checked="checked" type="radio" value="<html:rewrite page='/cambioImagenToken.do'/>" id="cambioImagenSeleccion" name="selection" onclick="evaluar();"/> <bean:message key="lbl.afirmacion"/> 
   			<input type="radio" value="<html:rewrite page='/activarPinToken.do'/>"	   id="activarPinSeguridad"  name="selection" onclick="evaluar();"/> <bean:message key="lbl.negacion"/>
	    </td>
	  </tr>
	  <tr>
	  	<td align="center">
	  		<html:hidden styleId="pantalla" property="pantalla" value="cambioImagenSeleccion" />
