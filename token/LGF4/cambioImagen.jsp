      ...
      <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default" >
          ...
          <div class="panel-body">
          	...
          	<div align="center">
          		<p><bean:message key="lbl.token.cambio.imagen.pregunta"/></p>
          		<p>
          		<label class="radio-inline">
          			<input checked="checked" type="radio" value="<html:rewrite page='/cambioImagenToken.do'/>" id="cambioImagenSeleccion" name="selection" onclick="evaluar();"/>
