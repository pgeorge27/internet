...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
	<td height="26" width="100%" colspan="2" align="right" style="height:26;background-color:#EFEFEF;"><div  class="fuente-principal"><bean:message key="tit.title.first.login.paso5"/></div></td>
  </tr>
  <tr valign="top"> 
    <td colspan="4">
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	...
	<div > 
		<table width="100%" border="0"  cellpadding="0" cellspacing="0">
												...
												<table>
													<tr>
														...
														<td align="left" class="fuente-titulo">
															<bean:message key="lbl.token.pregunta.seguridad.titulo"/>
														</td>
													</tr>
													...
													<tr>
														...
														<td class="fuente-principal">
															<bean:message key="lbl.token.pregunta.seguridad.msg"/><br/>
															<bean:message key="lbl.token.pregunta.seguridad.pregunta"/><br/>  
															<input type="radio" value="<html:rewrite page='/preguntaSeguridad.do' />"		   id="preguntasSeguridadForm" name="cambiarUsuario" onclick="evaluar();" checked="checked"/> <bean:message key="lbl.afirmacion"/> 
															<input type="radio" value="<html:rewrite page='/cargaInformacion.do' />" 		   id="cargaInformacion"  					   name="cambiarUsuario" onclick="evaluar();"/>   <bean:message key="lbl.negacion"/>
														</td>
													</tr>
			...
			<tr>
				<td height="20" valign="middle" class="texto-acceso">
				</td>
			</tr>
		</table>
	</div>
