...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="26" width="100%" colspan="2" align="right" style="height:26;background-color:#EFEFEF;"><div  class="fuente-recuadro-titulo"><bean:message key="tit.title.first.login.paso2"/></div></td>
  </tr>
  <tr valign="top"> 
    <td colspan="4">
                              ...
                              <tr> 
                                <td width="46%" rowspan="2"><div align="center"> 
                                    <table width="70%" border="0" cellspacing="2" cellpadding="2">
                                      ...
                                      <tr> 
                                        <td><div align="center" ><img align="right" src="<html:rewrite page='/do.GetImage'/>"  style=" width : 325px; height : 325px;"></div></td>
                                      </tr>
                                      <tr> 
                                        <td align="right" >
                                        <table width="100%">
                                        <tr>
                                        	<td width="60%"><div align="center" class="fuente-principal"><bean:message key="lbl.token.cambio.imagen.nombreImagen" /></div></td>
