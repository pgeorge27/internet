		...
		<div class="col-md-4">
			<div class="panel panel-default" >
				<div class="panel-heading">
					...
					<strong>
						<bean:message key="lbl.pregunta.tips.titulo"/>
					</strong>
				</div>
		...
		<div class="col-md-8">
			<div class="panel panel-default" >
				<div class="panel-heading">
					<img src="<html:rewrite page='/images/logo_icon.png' />" />
					<strong>
						<bean:message key="lbl.preg.secreta.titulo1a"/>
					</strong>
				</div>
				<div class="panel-body">
					<form name="forma" action="<html:rewrite page='/do.preguntastoken'/>" method="post">

						<p>1. <bean:message key="lbl.preg.secreta1"/></p>
						...
						<p><bean:message key="lbl.resp.secreta1"/></p>
						<p><input name="respuesta1" type="text" class="caja-acceso form-control" size="20" maxlength="50" value="<%=respuesta1 %>" ></p>
						<p><bean:message key="lbl.preg.secreta.conf.resp"/></p>
						<p><input name="confirma1" type="text" class="caja-acceso form-control" size="20" maxlength="50" value="<%=respuesta1 %>" >
						<span class="texto-acceso"><bean:message key="lbl.preg.secreta.rango"/></span>
						<p>2. <bean:message key="lbl.preg.secreta2"/></p>

						<select class="form-control"name="pregunta2">

							<option value="-1">
								<bean:message key="lbl.seleccion.pregunta"/>
							</option>
							<%
							for (int i=0; i<10; i++)
							{
						...
						<p><bean:message key="lbl.resp.secreta2"/></p>
						<p><input name="respuesta2" type="text" class="caja-acceso form-control" size="20" maxlength="50" value="<%=respuesta2 %>"></p>
						<p><bean:message key="lbl.preg.secreta.conf.resp"/></p>
						<p><input name="confirma2" type="text" class="caja-acceso form-control" size="20" maxlength="50" value="<%=respuesta2 %>"></p>
						<span class="texto-acceso"><bean:message key="lbl.preg.secreta.rango"/></span>
						<p>
						3. <bean:message key="lbl.preg.secreta3"/>
						<span class="texto-acceso">
						<bean:message key="lbl.preg.secreta.rango"/></span>
						</p>
						<p><bean:message key="lbl.preg.secreta3.texto"/></p>
						<p><input name="pregunta3" type="text" class="caja-acceso form-control" size="40" maxlength="50" value="<%=preg3 %>"></p>
						<p><bean:message key="lbl.preg.secreta3.confirm"/></p>
						<p><input name="confirmapreg3" type="text" class="caja-acceso form-control" size="40" maxlength="50" value="<%=preg3 %>"></p>
						<p><bean:message key="lbl.resp.secreta3"/></p>


						<p><input name="respuesta3" type="text" class="caja-acceso form-control" size="20" value="<%=respuesta3 %>"></p>
						<p><bean:message key="lbl.preg.secreta.conf.resp"/></p>
						<p><input name="confirma3" type="text" class="caja-acceso form-control" size="20" value="<%=respuesta3 %>"></p>
						<div align="center">
...
<%if (serv.equals("1")) {%> 
    <div height="31" colspan="4" style="width:100%;height:31;background-color:#4D4F53;"><div align="center" class="derechos">
