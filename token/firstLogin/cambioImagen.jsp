			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default" >
					<div class="panel-heading">
						...
						<strong>
							<bean:message key="lbl.token.cambio.imagen.titulo"/>
						</strong>
					</div>
					<div class="panel-body">

						<html:form method="post" action="/cambioImagenToken.do">
							<p><bean:message key="lbl.token.cambio.imagen.mensaje"/></p>
							<p><b><bean:message key="lbl.cambio.imagen.skip.warning"/></b></p>

							<div align="center">
								<p>
									<bean:message key="lbl.token.cambio.imagen.pregunta"/>
								</p>
								<p>
									...
									<label class="radio-inline">
										<input type="radio" value="<html:rewrite page='/activarPinToken.do'/>" id="activarPinSeguridad"  name="selection" onclick="evaluar();"/>
