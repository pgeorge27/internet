...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="26" width="100%" colspan="2" align="right" style="height:26;background-color:#EFEFEF;"><div  class="bienvenida"><bean:message key="tit.title.first.login.paso2"/></div></td>
  </tr>
  <tr valign="top"> 
    <td colspan="4">
					...
					<table>
						<tr>
							...
							<td><p class="fuente-titulo">
										<bean:message
											key="lbl.token.cambioImagen.success" />
									</p></td>
						</tr>
						<tr>
							<td></td>
							<td class="fuente-principal"><bean:message	key="lbl.token.cambio.imagen.success" /></td>
						</tr>
						<tr>
						  	<td colspan="2" align="center">
						  		<html:hidden  property="pantalla" value="activarPinSeguridad"/>
