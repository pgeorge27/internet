...
<table id="Table_01" width="95%" height="95%" border="0" cellpadding="0" cellspacing="0">
   <tr> 
        <td><br>
...
<table width="100%" border="0"  cellpadding="0" cellspacing="0">
  ...
  <tr align="center"> 
	...
	<form method="post" action="<html:rewrite page='/token/firstLogin/UploadpageToken.jsp'/>" name="forma">
