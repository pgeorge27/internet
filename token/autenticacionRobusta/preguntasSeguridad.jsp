...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
	<td height="26" width="100%" colspan="2" align="right" style="height:26;background-color:#EFEFEF;"><div  class="bienvenida"><bean:message key="tit.title.first.login.paso5"/></div></td>
  </tr>
  <tr valign="top"> 
    <td colspan="4">
									...
									<table cellspacing="3" cellpading="3" align="center" width="90%">
										...
										<tr>
											...
											<td class="bienvenida_2">
												...
												<bean:message key="lbl.token.pregunta.seguridad.pregunta"/><br/><br/>
												<input type="radio" value="/internet/preguntaSeguridad.do" id="preguntasSeguridadForm" name="cambiarUsuario" onclick="evaluar();" checked="checked"/> <bean:message key="lbl.afirmacion"/> 
												<input type="radio" value="/internet/preguntaSeguridad.do" id="perfilActualizado"  name="cambiarUsuario" onclick="evaluar();"/> <bean:message key="lbl.negacion"/>
											</td>
										</tr>
										<tr>
