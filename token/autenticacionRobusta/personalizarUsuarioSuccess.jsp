			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default" >
					<div class="panel-heading">
						...
						<strong><bean:message key="lbl.token.introduccion.cambioUsuario"/></strong>
					</div>
					<div class="panel-body">
						<div align="center">
							<img src="<html:rewrite page='/images/success.gif'/>">
						</div>
						<p class="bienvenida"><bean:message key="lbl.token.cambio.usuario.obs3" /></p>

						<div align="center">
							<html:form method="post" action="/personalizarUsuario.do">
								<html:hidden  property="pantalla" value="seleccionImagen"/>
