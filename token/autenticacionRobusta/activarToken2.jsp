...
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="26" width="100%" colspan="2" align="right" style="height:26;background-color:#EFEFEF;" class="bienvenida"><div  class="bienvenida" align="right"><bean:message key="tit.title.atenticacion.paso5"/></div></td>
  </tr>
  <tr valign="top"> 
    <td colspan="4">
  ...
  <tr valign="top">
     ...
     <!--  Tabla con Cajas -->     
		...
		<table width="600" border="0" cellpadding="0" cellspacing="2">
		  ...
		  <tr> 
			<td>&nbsp;</td><!---->
			<td colspan="2"><input id="espera" name="button" onclick="send();" type="button" class="botton" value="<bean:message key="btn.enviar"/>"> 
