...
<html>
<head>
<title>HELM BANK [PANAMA]</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link href="/internet/style/estilo.css" rel="stylesheet" type="text/css">
</head>
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<table id="Table_01" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="254" height="68" background="/internet/images/template_02.jpg"> <div align="left"><img src="/internet/images/template_01.jpg" width="254" height="68" alt=""></div></td>
    <td background="/internet/images/template_02.jpg"> <div align="right"><img src="/internet/images/template_04.jpg" width="242" height="68" alt=""></div></td>
  </tr>
                          ...
                          <td height="0"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                              <tr> 
                                <td width="46%" rowspan="2"><div align="center"> 
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                      <tr> 
                                        <td><div align="center"><img src="/internet/images/error.gif"></div></td>
                                      </tr>
                                     <tr> 
  ...
  <tr>
    <td height="31" colspan="4" style="width:100%;height:31;background-color:#4D4F53;"><div align="center" class="derechos"> 
        Derechos Reservados &copy; <%=java.util.Calendar.getInstance().get(java.util.Calendar.YEAR)%>. HELM BANK [PANAMA].</div></td>
  </tr>
</table>
</body>
</html>
