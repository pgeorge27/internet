...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
			...
			<tr>
				<td width="92%"><div align="left" class="login"><bean:message key="lbl.transf.inter.aprobacion" /></div></td>
				<td width="8%">
		...
		<%-- 	<html:hidden styleId="tipos" property="tipo" /> --%>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<tr valign="top" class="<%=cssClase %>" >
						<td class="bienvenida" nowrap><input type="checkbox" moneda="<%=t.getMoneda()%>" monedaIso="<%=t.getCodigoMonedaIso()%>" name="indice" value='<%=""+i %>' id="<%=tipo%>" /><a
						...
						<td class="bienvenida"><%=t.getUsuarioPrepara() == null ? "" : t
