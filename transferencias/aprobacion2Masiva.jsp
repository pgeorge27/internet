...
TransferenciaInternacional transf = (TransferenciaInternacional)session.getAttribute("tmasivo");
	...
	<td valign="top">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
            ...
            <tr valign="middle" class="celda-clave1">
                ...
                <td class="bienvenida"><%=transf.getCantidad()%></td></tr>                      
            <tr valign="middle">
			...
			<!-- <tr valign="middle" class="celda-clave1">
		        <td class="bienvenida" width="30%"><bean:message key="lbl.monto.firma.codigo.token.masivo"/></td>
                <td class="bienvenida"><%=StringUtilities.getValue(transf.getCuentaBeneficiario())%></td></tr> -->
