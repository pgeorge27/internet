...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
              <tr> 
                <td height="40" valign="bottom"><div align="center"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        <td valign="bottom">
                        	<div align="left" class="login" ><img src="<html:rewrite page='/images/gancho.gif' />"/>
                        	<bean:message key="lbl.compensacion.menu.reprocesos"/></div>
                        </td>
                         </tr>
                    </table>
                  </div></td>
              ...
              <tr> 
				...
				<html:form method="post" action="/consulta/estado/reprocesar">
                    ...
                    <!--
                      ...
                      <tr> 
                        <td colspan="3"><table width="95%" border="0" align="center" cellpadding="5" cellspacing="5">
                            <tr> 
