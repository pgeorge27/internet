		...
		<td height="40" valign="bottom"><div align="center"> 
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
				<tr>
					...
					<td><div align="left" class="login"><bean:message key="lbl.compensacion.modificar.titulo"/></div></td>
				</tr>
			</table>
		</div></td>
	</tr>
	<tr> 
		...
		<%@ include file="../divHeader.jsp"%>
			<table width="450px" border="0" align="center" cellpadding="5" cellspacing="5">
				...
				<tr>
					<td width="41%" class="celda-clave1"><div align="right" class="texto-acceso"><bean:message key="lbl.compensacion.consulta.estado"/></div></td>
					<td width="59%">
						<html:select property="estado" styleClass="lstbox">
