...
function send(){
    ...
    if (document.forms['consultaEstadoForm'].estado.value == "")
	{
	   alert("<bean:message key="msg.seleccionar.estado"/>");
	   document.forms['consultaEstadoForm'].estado.focus();
	   return;
	}
	if (t == "3"){
...
<div class="container">
 ...
 <div class="col-md-1"></div>
          ...
          <div class="col-md-10"><div class="panel panel-default">
					 <div class="panel-heading" align="justify" ><img src="<html:rewrite page='/images/logo_icon.png' />" /><strong><bean:message key="lbl.compensacion.modificar.titulo"/></strong></div>
  ...
  <div class="col-md-5">		<html:select property="estado" styleClass="form-control">
							<html:option value=""><bean:message key="lbl.seleccione.un.estado"/></html:option>
							<html:option value="M"><bean:message key="lbl.compensacion.consulta.estado.pendiente"/></html:option>
  ...
  <div class="col-md-3"><input type="button" class="calendar2" value=" " id="date_trigger1" onclick="return showCalendar('hasta', 'dd-mm-y');" > [<b>dd-mm-yyyy</b>]</div>
