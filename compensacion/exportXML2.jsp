			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2" class="linea-botton">
			  <tr> 
				...
				<td width="8%"><div align="right">&nbsp;
							<INPUT class="botton" onclick="document.location='<html:rewrite page='/general/xml.do'/>'" type="button" value="<bean:message key="lbl.retroceder"/>"></div></td>
			  </tr>
			</table></div></td>
	  </tr>
	  <tr> 
...
<tr class="tabla-acceso">
    ...
    <td class="texto-acceso" width="35%"><bean:message key="lbl.descripcion"/></TD>
    ...
    <td class="texto-acceso" width="25%"><bean:message key="lbl.compensacion.consulta.estado.nombre"/></TD>
    <td class="texto-acceso" width="10%"><bean:message key="lbl.compensacion.consulta.estado"/></TD></tr>
...
<TR valign="top" <%=styleClass%>>
	...
	<%}else{%>
		&nbsp;
	<%}%></TD>
    <TD class="bienvenida"><bean:message key="<%=getDescEstado(m.getEstado())%>"/></TD></TR>
<%} /* End for - loop*/ %>
...
<table width="80%" border="0" cellpadding="0" cellspacing="2">
	...
	<tr> 
		<td valign="top" class="texto-acceso" colspan="2"><div align="center"><br>
				<INPUT class="botton" onclick="document.location='<html:rewrite page='/general/xml.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></div></td></tr>
</table>					
<%
}
else
