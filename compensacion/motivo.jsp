                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> 
                        ...
                        <td width="8%"><div align="right">&nbsp;
							<INPUT class="botton" onclick="document.location='<html:rewrite page='/compensacion/autorizar2.jsp'/>'" type="button" value="<bean:message key="lbl.retroceder"/>"></div></td>
                        </tr>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="1" style="overflow:scroll;width:50%">
                     ...
                     <tr align="center">
                        ...
                        <td class="bienvenida"><textarea name="motivo" cols="40" rows="4" onkeypress="alphabetic();validateLength(this, 1000)"class="txtTexto" id="motivo"></textarea>
                        </td>
                     </tr>
                    <tr>
					    <td valign="top" class="texto-acceso" colspan="2"><div align="center"><br>&nbsp;&nbsp;
					       <input type="submit" class="botton" value="Continuar"/> &nbsp;<INPUT class="botton" onclick="document.location='<html:rewrite page='/compensacion/autorizar2.jsp'/>'" type="button" value="<bean:message key="lbl.retroceder"/>"></div></td>
