...
if (objEstCta instanceof com.arango.internet.banking.EstadoCuenta){
	...
	mov = (java.util.ArrayList)session.getAttribute("detalle");
...
<html:form method="post" action="<%=(String)session.getAttribute("form.back") %>">
...
<html:hidden property="estado" value="<%=session.getAttribute("estado.consulta")%>"/>
</html:form>
...
<tr class="tabla-acceso">    
    <td class="texto-acceso" width="20%" nowrap><bean:message key="lbl.est.cta.fecha.valida"/></TD>
    <td class="texto-acceso" width="40%"><bean:message key="lbl.descripcion"/></TD>
 	<td class="texto-acceso" width="20%">Valor</td>
...
<TR valign="top" <%=styleClass%>>    
   <TD class="bienvenida" align=left width="14%"><%=f.formatFecha(m.getFecha(), locale)%></TD>    
...
<TD class="bienvenida" style="color:blue;CURSOR: hand" 
	...
	<TD class="bienvenida" align=right width="21%"><%=f.formatMonto(m.getMonto()) %></TD>         
     </TR>		 
	 	 <%} /* End for - loop*/ %>    
		</table>    
...
<table width="80%" border="0" cellpadding="0" cellspacing="2">
	...
	<tr>
	<td colspan="2" valign="top" class="texto-acceso">
                <div align="center">
					<a href="<html:rewrite page='/compensacion/detalleMovPdf.jsp'/>" target="_new"><img src="<html:rewrite page='/images/icono_acrobat.gif'/>" border="0"><bean:message key="lbl.descargar.pdf"/></a>
					<br></div></td>
	</tr>
	<tr> 
