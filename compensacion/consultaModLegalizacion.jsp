...
if (ec == null){   
	...
	pageContext.forward(request.getContextPath()+ "/selec/Modlegalizaciones.do");  
	return;
}
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2" class="linea-botton">
			  <tr> 
				...
				<img src="<html:rewrite page='/images/gancho.gif' />"/>
					Modificar Legalizaciones de Operaciones de Cuenta de Compensación </div></td>
				<td width="8%"><div align="right">&nbsp;
							<INPUT class="botton" onclick="document.location='<html:rewrite page='/selec/Modlegalizaciones.do'/>'" type="button" value="<bean:message key="lbl.retroceder"/>">							
							</div></td>
				<td width="8%"><div align="right">&nbsp;
...
%>
<html:form method="post" action="/consulta/Modlegalizaciones">
...
<tr> 
	<td valign="top" class="texto-acceso"><div align="center"><br>
			<INPUT class="botton" onclick="document.location='<html:rewrite page='/selec/Modlegalizaciones.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></div></td></tr>
</table>
<%
}
%>
