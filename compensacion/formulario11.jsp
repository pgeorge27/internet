...
"cfAnt=<bean:write name='formulario' property='cfAnt'/>&"+
"seqAnt=<bean:write name='formulario' property='seqAnt'/>&"+
"seqfAnt=<bean:write name='formulario' property='seqfAnt'/>&"+
"seqdAnt=<bean:write name='formulario' property='seqdAnt'/>&"+
"estadoOriginal=<bean:write name='formulario' property='estadoOriginal'/>&"+ 
