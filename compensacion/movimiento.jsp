...
if (ec == null){   
	...
	pageContext.forward(request.getContextPath()+ "/mant/cuenta.do");  
	return;
}
...
session.setAttribute("extraer.datos","false");
session.setAttribute("form.back","/consulta");
%>
	  ...
	  <tr> 
		<td height="40" colspan="2" valign="bottom"><div align="center"> 
			<table width="100%" border="0" cellpadding="2" cellspacing="2" class="linea-botton">
			  <tr> 
				<td width="84%"><div align="left" class="login">
				...
				<td width="8%"><div align="right">&nbsp; <input type="button" class="botton" value="<bean:message key="lbl.compensacion.refrescar"/>" onclick="__refresh();"></div></td>
				<td width="8%"><div align="right">&nbsp;
							<INPUT class="botton" onclick="document.location='<html:rewrite page='/mant/cuenta.do'/>'" type="button" value="<bean:message key="lbl.retroceder"/>"></div></td>
...
<!-- Agregando un bean message Edgar Sucre => 03/03/2012-->
<tr>
	
	<td colspan="6">
		<div style="color: red; font-size: 15px; font-weight: bold;" align="center"><bean:message key="lbl.compensacion.movimientos.warning" /></div>
	</td>
	
</tr>

<tr class="tabla-acceso">    
    <td class="texto-acceso" width="25%" nowrap><bean:message key="lbl.est.cta.fecha.valida"/></TD>
    ...
    <td class="texto-acceso" width="17%" align="right">&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="lbl.credito"/></TD>
     <td class="texto-acceso" width="15%">Valor Pendiente</td>
...
<TR valign="top" <%=styleClass%>>    
   <TD class="bienvenida" align=left width="14%"><%=f.formatFecha(m.getFechaValida(), locale)%></TD>    
...
<TD class="bienvenida" 
    align=left width="30%" style="color:blue;CURSOR: hand" onclick="location.href='<%=request.getContextPath() %>/detalles/movimiento.do'"><SPAN id=desc style="color:blue;hand;font-size:10px;font-family: Verdana, Arial, Helvetica, sans-serif;"><%=m.getDescripcion()%></SPAN></TD>
<%} %>
    ...
    <TD class="bienvenida" align=right width="16%"><%="C".equals(m.getTipoTransaccion())?f.formatMonto(m.getMonto()):"&nbsp;"%></TD>
     <TD class="bienvenida" align=right width="21%"><%=f.formatMonto(m.getValorPendiente()) %></TD>         
     <td>
        
     		<input type="button" name="btn<%=i%>" value="Asociar" onclick="__asociar(<%=i %>)"/>
     </td></TR>		 
	 	 <%} /* End for - loop*/ %>    
		</table>    
...
<table width="80%" border="0" cellpadding="0" cellspacing="2">
	...
	<tr> 
		<td valign="top" class="texto-acceso" colspan="2"><div align="center"><br>
			  ...
			  &nbsp;&nbsp;
				<INPUT class="botton" onclick="document.location='<html:rewrite page='/mant/cuenta.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></div></td></tr>
</table>					
<%
}
else
