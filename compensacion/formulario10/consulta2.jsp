			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2" class="linea-botton">
			  <tr> 
				...
				<td width="8%"><div align="right">&nbsp;
							<INPUT class="botton" onclick="document.location='<html:rewrite page='/formulario10/seleccion/estado.do'/>'" type="button" value="<bean:message key="lbl.retroceder"/>"></div></td>
			  </tr>
			</table></div></td>
	  </tr>
	  <tr> 
...
<tr class="tabla-acceso">
    <td class="texto-acceso">Período</td>
...
<TR valign="top" <%=styleClass%>>
    ...
    <TD class="bienvenida"><a  href="javascript:_submit(<%=i%>);"><%=m.getFormulario() %> - <%=m.getNombre()%></a></TD>
...
<table width="80%" border="0" cellpadding="0" cellspacing="2">
	...
	<tr> 
		<td valign="top" class="texto-acceso" colspan="2"><div align="center"><br>
				<INPUT class="botton" onclick="document.location='<html:rewrite page='/formulario10/seleccion/estado.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></div></td></tr>
</table>					
<%
}
else
