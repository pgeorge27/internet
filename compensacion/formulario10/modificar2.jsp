...
<p><INPUT class="btn btn-default" onclick="document.location='<html:rewrite page='/formulario10/mant/modificar.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></p>
</div>
