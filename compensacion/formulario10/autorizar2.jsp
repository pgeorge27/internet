  ...
  <div class="row" style="padding-right: 3%; padding-left: 3%;">
    ...
    <div class="col-md-12">
      <div class="panel panel-default" >
        ...
        <div align="right">
          <INPUT class="btn btn-default" onclick="document.location='<html:rewrite page='/formulario10/compensacion/contrato.do'/>'" type="button" value="<bean:message key="lbl.retroceder"/>">
        </div>
...
<div class="row"></div>
<div align="center">
  <p><bean:message key="lbl.cc.descripcion.observacion"/></p>
</div>
<div class="row"></div>
...
<p><INPUT class="btn btn-default" onclick="document.location='<html:rewrite page='/formulario10/compensacion/contrato.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></p>
</div>
