...
var t;
function send(){
    if (document.forms['generarXML3_4_10Form'].cuenta.value == "")
	{
	   alert("<bean:message key="msg.seleccionar.cuenta"/>");
	   document.forms['generarXML3_4_10Form'].cuenta.focus();
	   return;
	}	
	
	document.forms['generarXML3_4_10Form'].submit();
}
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
                ...
                <td height="40" valign="bottom"><div align="center"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> <td width="50px"> <img src="<html:rewrite page='/images/gancho.gif'/>" border="0"></td>
                        <td><div align="left" class="login"><bean:message key="lbl.compensacion.menu.generar.xml.ban.rep"/></div></td>
                       </tr>
                    </table>
                  </div></td>
              </tr>
             <tr> 
				...
				<html:form method="post" action="/formulario10/generar/xml3_4_10">
                  ...
                  <%@ include file="../../../divHeader.jsp"%>
                    <table width="450" border="0" align="center" cellpadding="5" cellspacing="5">
                      ...
                      <tr>
                        <td>&nbsp;<br><br></td>
                        <td><input name="botonEnviar" onclick="send();" type="button" class="botton" value="<bean:message key="lbl.compensacion.generar.xml"/>">&nbsp;&nbsp;&nbsp;&nbsp; 
