...
%>
<div align="center"> 
<html:form method="post" action="/formulario10/compensacion/aceptacion">
  ...
  <tr> 
	...
	<div align="center"> 
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
		  <tr> 
			<td width="92%"><div align="left" class="login">Contrato Helm Compensación</div></td>
			<td width="8%">
				<div align="center"><a href="<html:rewrite page='/compensacion/printContrato.jsp'/>" target="_new"><img src="<html:rewrite page='/images/printer2.jpg'/>" width="37" height="32" border="0"></a></div>
			</td>
		  </tr>
		</table>
	  </div></td>
