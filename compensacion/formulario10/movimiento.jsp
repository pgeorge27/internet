...
<tr class="tabla-acceso">
	<td class="texto-acceso" width="80%"><bean:message key="lbl.compensacion.consulta.estado.nombre"/></TD>
...
<tr>
		...
		<td width="456" height="14"><font size="1">
			...
			<a target="new"  href="/generador/archivo/cambios/INSTRUCCIONES_F10.pdf">
			Instrucciones</a>
		</font></td>
	</tr>
<TR valign="top" <%=styleClass%>>
	...
	<%}else{%>
		&nbsp;
	<%}%></TD>
     <td><input type="button" name="btn<%=i%>" value="Asociar" onclick="__asociar(<%=i %>)"/></td></TR>
<%} /* End for - loop*/ %>
