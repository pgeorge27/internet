  ...
  <div class="row" style="padding-right: 3%; padding-left: 3%;">
    ...
    <div class="col-md-12">
      <div class="panel panel-default" >
        ...
        <div align="right">
          <INPUT class="btn btn-default" onclick="document.location='<html:rewrite page='/formulario10/mant/reproceso.do'/>'" type="button" value="<bean:message key="lbl.retroceder"/>">
        </div>
...
<p><b><bean:message key="lbl.periodo"/></b>
<%=session.getAttribute("periodo.consulta")%></p>
...
<p><INPUT class="btn btn-default" onclick="document.location='<html:rewrite page='/formulario10/mant/reproceso.do'/>'" type=button value="<bean:message key="lbl.retroceder"/>"></p>
</div>
