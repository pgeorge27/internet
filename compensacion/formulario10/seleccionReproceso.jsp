...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
                ...
                <td height="40" valign="bottom"><div align="center"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> <td width="50px"> <img src="<html:rewrite page='/images/gancho.gif'/>" border="0"></td>
                        <td><div align="left" class="login">Reproceso de Relación de Operaciones de Cuentas de Compensación</div></td>
                      </tr>
                    </table>
                  </div></td>
              </tr>
              <tr> 
				...
				<html:form method="post" action="/formulario10/consulta/estado/reprocesar">
					<!--<html:hidden property="estado" value="A"/>-->
					<html:hidden property="unico" value="f10R"/>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
                      ...
                      <tr>
                        <td>&nbsp;<br><br></td>
                        <td><input name="botonEnviar" onclick="send();" type="button" class="btn btn-default" value="<bean:message key="btn.consultar"/>">&nbsp;&nbsp;&nbsp;&nbsp; 
							<input TYPE="BUTTON" class="btn btn-default" VALUE="<bean:message key="lbl.retroceder"/>" onclick="retornar()"></td>
                      </tr>
                    </table>
