                ...
                <td height="40" valign="bottom"><div align="center"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
                      <tr> <td width="50px"> <img src="<html:rewrite page='/images/gancho.gif'/>" border="0"></td>
                        <td><div align="left" class="login">Consulta de Relación de Operaciones de Cuentas de Compensación</div></td>
                       </tr>
                    </table>
                  </div></td>
              </tr>
				...
				<html:hidden property="tipo" value="3"/>
                  <%@ include file="../../divHeader.jsp"%>
                    <table width="450" border="0" align="center" cellpadding="5" cellspacing="5">
                      ...
                      <tr> 
                        <td colspan="3"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="5">
                            <tr> 
                              <td width="33%" height="15"><html:radio property="tipo" styleId="TipoOperacion" value="1" onclick="setValue(1);"/>
                                <span class="texto-acceso"><bean:message key="lbl.movimientos.dia"/> </span></td>
                              <td width="33%"><html:radio property="tipo" styleId="TipoOperacion" value="2" onclick="setValue(2);"/>
                                <span class="texto-acceso"><bean:message key="lbl.movimientos.mes"/></span></td>
                              <td width="33%"><html:radio property="tipo" styleId="TipoOperacion" value="3" onclick="setValue(3);"/>
                      ...
                      <tr> 
                        ...
                        <td width="59%">
                            <html:select property="cuenta" styleClass="lstbox">
							   	 ...
							   	 </html:select></td><td> <span class="texto-acceso">(<font color="#FF0000">*</font>)</span></td>
                      </tr>
                      <tr> 
						<td class="celda-clave1"><div align="right" class="texto-acceso"><bean:message key="lbl.compensacion.consulta.estado"/></div></td>
						<td nowrap><html:select property="estado" styleClass="botton-acceso">
