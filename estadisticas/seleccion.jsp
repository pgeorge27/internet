	      	...
	      	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea-botton">
	        	<tr>
	        		<td width="50px"> <img src="<html:rewrite page='/images/gancho.gif'/>" border="0"></td>
	          		<td><div align="left" class="login"><bean:message key="lbl.compensacion.movimiento.titulo.estadistica"/></div></td>
	          	</tr>
	     	</table>
	    	</div>
	    </td>
	...
	<tr>
		...
		<table width="90%" border="0" align="center" cellpadding="5" cellspacing="5">
            ...
            <tr>
			    ...
			    <td>
					<html:select property="formulario" styleId="formulario" styleClass="lstbox">
			...
			<tr>
				<td class="celda-clave1"><div align="right" class="texto-acceso"><bean:message key="lbl.numeral"/></div></td>
				<td nowrap>
					<html:select property="numeral" styleId="numeral" styleClass="lstbox">
						<html:option value="0">Todos</html:option>
					</html:select> 
					<span class="texto-acceso">(<font color="#FF0000">*</font>)</span>
				</td>
            ...
            <tr>
				...
				<td nowrap>
					<html:select property="estado" styleClass="botton-acceso">													
						<html:option value="0">Todos</html:option>
